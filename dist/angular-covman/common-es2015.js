...
class UserDataService {
    ...
    addParent(parent) {
        return this.httpClient.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].parents, parent, {
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(response => { return response; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    }
    /**
    ...
    getUser(email, password) {
        let url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].users + "/" + email + "/" + password;
