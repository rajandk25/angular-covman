...
/* harmony import */ var src_app_common_services_toast_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/common/services/toast.service */ "./src/app/common/services/toast.service.ts");
/* harmony import */ var src_app_common_services_user_data_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/common/services/user-data.service */ "./src/app/common/services/user-data.service.ts");
/* harmony import */ var _common_models_parent_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../../common/models/parent.model */ "./src/app/common/models/parent.model.ts");
/* harmony import */ var _common_models_user_model__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./../../common/models/user.model */ "./src/app/common/models/user.model.ts");
...
/* harmony import */ var primeng_message__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! primeng/message */ "./node_modules/primeng/__ivy_ngcc__/fesm2015/primeng-message.js");
...
function RegisterUserComponent_div_9_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 7);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](1, "p-message", 20);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function RegisterUserComponent_div_16_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 7);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](1, "p-message", 21);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function RegisterUserComponent_div_22_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 7);
...
function RegisterUserComponent_div_34_p_message_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "p-message", 29);
} }
function RegisterUserComponent_div_34_p_message_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "p-message", 30);
} }
function RegisterUserComponent_div_34_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 7);
...
class RegisterUserComponent {
    ...
    handleRegister() {
        ...
        let parent = new _common_models_parent_model__WEBPACK_IMPORTED_MODULE_5__["Parent"]();
        let firstname = this.userform.controls["firstName"].value;
        let lastname = this.userform.controls["lastName"].value;
        let email = this.userform.controls["emailId"].value;
        let password = this.userform.controls["password"].value;
        //parent need User object, so create that and set to the parent
        let user = new _common_models_user_model__WEBPACK_IMPORTED_MODULE_6__["User"]();
        ...
        this.userService.addParent(parent).subscribe((data) => {
            console.log(data);
            if (data) {
...
RegisterUserComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RegisterUserComponent, selectors: [["app-register-user"]], decls: 42, vars: 7, consts: [[1, "user-regisration"], [1, "p-grid", "p-nogutter", "p-justify-center", "p-align-center", 2, "height", "100%"], [1, "p-col-5"], [3, "formGroup", "ngSubmit"], ["header", "Register"], [1, "p-grid", "p-justify-center", "p-align-center"], ["class", "p-col-8", 4, "ngIf"], [1, "p-col-8"], [1, "ui-inputgroup"], [1, "ui-inputgroup-addon"], [1, "fa", "fa-user"], ["id", "float-input-firstname", "type", "text", "size", "30", "pInputText", "", "formControlName", "firstName", "placeholder", "First Name", "required", ""], ["id", "float-input-lastname", "type", "text", "size", "30", "pInputText", "", "formControlName", "lastName", "placeholder", "Last Name", "required", ""], [1, "fa", "fa-at"], ["id", "float-input-emailid", "type", "email", "size", "30", "pInputText", "", "formControlName", "emailId", "placeholder", "Parent Email Id", "required", ""], [1, "fa", "fa-key"], ["id", "float-input-password", "type", "password", "size", "30", "pInputText", "", "formControlName", "password", "placeholder", "Password", "required", ""], [1, "p-col-3"], ["pButton", "", "type", "button", "label", "Register", 1, "ui-button-raised", 3, "disabled", "click"], ["pButton", "", "type", "button", "label", "Login", 1, "ui-button-raised", 3, "click"], ["severity", "error", "text", "Error Registering the user. Please retry."], ["severity", "error", "text", "First name is required"], ["severity", "error", "text", "Last name is required"], ["severity", "error", "text", "Email is required", 4, "ngIf"], ["severity", "error", "text", "Email is invalid", 4, "ngIf"], ["severity", "error", "text", "Email is required"], ["severity", "error", "text", "Email is invalid"], ["severity", "error", "text", "Password is required", 4, "ngIf"], ["severity", "error", "text", "Minimum 6 characters required.", 4, "ngIf"], ["severity", "error", "text", "Password is required"], ["severity", "error", "text", "Minimum 6 characters required."]], template: function RegisterUserComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterUserComponent_Template_button_click_39_listener() { return ctx.handleRegister(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](40, "div", 17);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](41, "button", 19);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterUserComponent_Template_button_click_41_listener() { return ctx.routeToLogin(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RegisterUserComponent, [{
    ...
    }], function () { return [{ type: src_app_common_services_user_data_service__WEBPACK_IMPORTED_MODULE_4__["UserDataService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }, { type: src_app_common_services_toast_service__WEBPACK_IMPORTED_MODULE_3__["ToastService"] }]; }, null); })();
